...
<head>
    ...
    <link rel="stylesheet" href="/demo/dist/assets/css/pages/auth.css">
</head>
...
<div id="auth">
    ...
    <div class="row h-100">
        <div class="col-lg-5 col-12">
            <div id="auth-left">
                <div class="auth-logo">
                    <a href="/"><img src="/demo/dist/assets/images/logo/logo.png" alt="Logo"></a>
                </div>
                ...
                <form action="/login/loginProc" method="post">
                    <div class="form-group position-relative has-icon-left mb-4">
                        <input type="text" name="user_id" class="form-control form-control-xl" placeholder="Username">
